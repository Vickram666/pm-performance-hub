...
import { ClipboardCheck, ArrowRight, MessageCircle, CheckCircle2, Circle } from 'lucide-react';
...
export function InspectionsPanel({ onOpenProperty, onCommunicate }: Props) {
              ...
              <div className="pl-2">
                <div className="flex items-center gap-2 flex-wrap mb-1">
                  ...
                  <span className="font-medium text-sm truncate">
                    {INSP_LABEL[r.type]} — {r.propertyName}
                  </span>
                  ...
                  <div className="flex items-center gap-1" onClick={(e) => e.stopPropagation()}>
                    <Button size="sm" variant="ghost" className="h-7 text-xs gap-1"
                      onClick={() => onCommunicate({
                        taskTitle: `${INSP_LABEL[r.type]} pending`,
                        nextStep: r.nextAction,
                        contactName: r.ownerName,
                        propertyName: r.propertyName,
                        propertyId: r.propertyId,
                        category: INSP_LABEL[r.type],
                      })}>
